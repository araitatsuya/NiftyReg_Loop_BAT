...
Though, I highly discourage you to install NiftyReg on Windows. Apparently the installation requires Framework 4.0 and older version of Visual Studio (2010?). But the current Windows (as of May 2016, Windows 7(Yes 7), Framework 4.5) does not support the old library and keeps on rewriting to newer Framework.
